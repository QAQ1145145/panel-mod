    ...
    */
	...
	public static function getUserTraffic($user){
		if($user->unusedTraffic()>0){
			...
			$ssurl = "127.0.0.1:1:auth_chain_a:chacha20:tls1.2_ticket_auth:YnJlYWt3YWxs/?obfsparam=&protoparam=&remarks=".Tools::base64_url_encode("流量已用尽！")."&group=".Tools::base64_url_encode(Config::get('appName'));
		}
      	return "ssr://".Tools::base64_url_encode($ssurl);
	}
