   ...
   <section class="row no-gutters" id="features"> 
    ...
    <div class="col-lg-3 col-md-6 purple lighten-1 text-white"> 
     <div class="p-5 text-center wow zoomIn" data-wow-delay=".3s">
      ...
      <p class="mt-5">在谷歌学术、ScienceDirect、BASE Search等网站上快速搜索学术论文资料。或手机上使用．</p> 
     </div> 
    </div> 
      ...
      <div class="col-lg-6 col-xl-7 mb-3"> 
       <div class="row mb-3"> 
        ...
        <div class="col-10"> 
         ...
         <p class="grey-text"> 在whatsapp与海外客户自由地沟通合作、在线协作和无障碍交易，以及黑五海淘等. </p> 
        </div> 
       </div> 
       <div class="row mb-3"> 
        <div class="col-1 mr-1">
        ...
        <div class="col-10"> 
         ...
         <p class="grey-text"> 在Ins上关注爱豆最新动态，与自己的朋友分享心仪的照片，延迟超低，图片秒开. </p> 
        </div> 
       </div> 
       <div class="row mb-3"> 
        <div class="col-1 mr-1">
        ...
        <div class="col-10"> 
         ...
         <p class="grey-text"> 在谷歌学术、ScienceDirect、BASE Search、Amazon A9等网站上快速搜索学术论文资料. </p> 
        </div> 
       </div> 
      </div> 
