...
<html class="full-height" lang="zh">
 <head> 
  ...
  <title>叮当加速—专注国际服游戏加速</title> 
  <meta name="keywords" content="游戏加速,网络优化,网络加速,路由器加速,手机加速,ps4加速,Steam加速器,xbox加速,外服加速,叮当加速" /> 
  <link href="/static/css/bootstrap.min.css" rel="stylesheet" /> 
  <link href="/static/css/material-dash.css" rel="stylesheet" /> 
  <link href="/static/css/animate.min.css" rel="stylesheet" /> 
  <link href="/static/css/b84db50ba4364bc29a2474f412c45425.css" rel="stylesheet" /> 
...
#pricing .card-image {
  background: url("/static/images/login.jpeg") no-repeat center center;
}
       ...
       <div class="col-md-10 col-lg-6 text-center text-md-left margins"> 
        <div class="white-text"> 
         <div class="wow fadeInLeft" data-wow-delay="0.3s" style="text-shadow:2px 2px 2px #000;"> 
          <h1 class="h1-responsive font-bold mt-sm-5">{$config["appName"]}</h1> 
          <div class="h6" style="text-transform:none">
            拥有多条阿里云内网专线、CN2GIA、IIJ、HKT、HKBN、Hinet、GCP、AWS、bbtec等多条高质量线路，支持H1Z1、战地、绝地求生、Apex等大部分外服游戏加速。 
          </div> 
         </div>
         <br /> 
         <div class="wow fadeInLeft" data-wow-delay="0.3s"> 
          <a class="btn btn-white dark-grey-text font-bold ml-0" href="/auth/register" target="_blank"><i class="material-icons">person_add</i>注册</a> 
          <a class="btn btn-outline-white waves-effect waves-light" href="/auth/login"><i class="material-icons">fingerprint</i> 登录</a> 
         </div> 
        </div> 
       </div> 
      </div> 
      <div class="banner0-icon">
       <i class="anticon anticon-down bounce"></i>
      </div> 
     </div> 
    </div> 
   </section> 
   ...
   <section class="row no-gutters" id="features"> 
    <div class="col-lg-3 col-md-6 col-sm-12 deep-purple lighten-1 text-white"> 
     <div class="p-5 text-center wow zoomIn" data-wow-delay=".1s">
      ...
      <p class="mt-5">接入深新、深港、杭港、京港、沪港、沪日、沪韩、沪美等多条『内网』专线，畅游CSGO，R6，PUBG，战地等热门外服游戏．</p> 
     </div> 
    </div> 
    <div class="col-lg-3 col-md-6 purple lighten-1 text-white"> 
     <div class="p-5 text-center wow zoomIn" data-wow-delay=".3s">
      ...
      <p class="mt-5">在各种学术网站，如ScienceDirect、BASE Search等网站上快速搜索学术论文资料.</p> 
     </div> 
    </div> 
    <div class="col-lg-3 col-md-6 teal lighten-1 text-white"> 
     <div class="p-5 text-center wow zoomIn" data-wow-delay=".5s">
      ...
      <p class="mt-5">可帮助外国人通过邮箱给家人发邮件，或解锁各种流媒体限制. </p> 
     </div> 
    </div> 
   ...
   <section class="py-5" id="projects"> 
    <div class="container"> 
     <div class="wow fadeIn"> 
      ...
      <p class="px-5 mb-5 pb-3 lead blue-grey-text text-center"> </p> 
     </div> 
     <div class="row wow fadeInLeft" data-wow-delay=".3s"> 
      <div class="col-lg-6 col-xl-5 pr-lg-5 pb-5">
       <img class="img-fluid rounded z-depth-2" src="/static/picture/card-1.jpg" alt="project image" />
      </div> 
      <div class="col-lg-6 col-xl-7 pl-lg-5 pb-4"> 
       <div class="row mb-3"> 
        <div class="col-1 mr-1">
         <i class="fa fa-steam fa-2x cyan-text"></i>
        </div> 
        <div class="col-10"> 
         <h5 class="font-bold">游戏党</h5> 
         <p class="grey-text"> 在索尼PS4，微软Xbox Live、Steam、Battle.net 和其它PC游戏如战地，黑沙，PUBG，彩虹魔兽世界等游戏上享受低延迟的畅玩体验。. </p> 
        </div> 
       </div> 
       <div class="row mb-3"> 
        <div class="col-1 mr-1">
         <i class="fa fa-youtube fa-2x red-text"></i>
        </div> 
        <div class="col-10"> 
         <h5 class="font-bold">影视党</h5> 
         <p class="grey-text"> 在线观看Netflix或Twitch等，超大带宽让您可以以流畅的速度观看2K、4K，甚至8K视频(取决于您的网络接入宽带)． </p> 
        </div> 
       </div> 
       <div class="row"> 
        <div class="col-1 mr-1">
         <i class="fa fa-buysellads fa-2x deep-purple-text"></i>
        </div> 
        <div class="col-10"> 
         <h5 class="font-bold">设计师</h5> 
         <p class="grey-text"> 在Smashing Magazine、Flickr、DeviantArt等网站上轻松获得设计素材，加入Github、Stack OverFlow、Reddit、Android.com等编程社区自由交谈. </p> 
        </div> 
       </div> 
      </div> 
     </div> 
      ...
      <div class="col-lg-6 col-xl-7 mb-3"> 
       <div class="row mb-3"> 
        ...
        <div class="col-10"> 
         ...
         <p class="grey-text"> 海外客户自由地沟通合作、在线协作和无障碍交易，以及黑五海淘等. </p> 
        </div> 
       </div> 
       <div class="row mb-3"> 
        <div class="col-1 mr-1">
        ...
        <div class="col-10"> 
         ...
         <p class="grey-text"> 关注爱豆最新动态，与自己的朋友分享心仪的照片，延迟超低，图片秒开. </p> 
        </div> 
       </div> 
       <div class="row mb-3"> 
        <div class="col-1 mr-1">
        ...
        <div class="col-10"> 
         ...
         <p class="grey-text"> 在各种学术网站，如ScienceDirect、BASE Search等网站上快速搜索学术论文资料. </p> 
        </div> 
       </div> 
      </div> 
      <div class="col-lg-6 col-xl-5 mb-3">
       <img class="img-fluid rounded z-depth-2" src="/static/picture/card-2.jpeg" alt="project image" />
      </div> 
     </div> 
    </div> 
   </section> 
  ...
  <footer class="page-footer indigo darken-2 center-on-small-only pt-0 mt-0"> 
   ...
   <div class="footer-copyright"> 
    <div class="container-fluid"> 
     <p>&copy; <a href="/"></a>Design By <a style="color: rgba(255, 255, 255, 0.6);" href="#" target="_blank" rel="nofollow">110</a></p> 
    </div> 
   </div> 
  </footer> 
