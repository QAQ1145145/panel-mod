											...
											<div class="tab-content">
												<div class="tab-pane fade {if $ssr_prefer}active in{/if}" id="all_ssr">
													...
													<div class="tab-pane fade active in" id="all_ssr_windows">
														...
														<p><span class="icon icon-lg text-white">looks_one</span> 下载<a href="https://qcloud.coding.net/u/bfsdo0/p/tap-mod/git/raw/master/ssr-win.7z">客户端</a>和<a href="/user/getpcconf?is_mu=0&is_ss=0">配置文件</a></p>
													...
													<div class="tab-pane fade" id="all_ssr_mac">
															<p><span class="icon icon-lg text-white">looks_one</span><a href="https://qcloud.coding.net/u/bfsdo0/p/tap-mod/git/raw/master/ssr-mac.dmg"> 点击我下载</a></p>
                                                      ...
                                                      <p><span class="icon icon-lg text-white">looks_6</span> 菜单栏的纸飞机图标-打开shadowsocks</p>
                                                        ...
                                                        <p><span class="icon icon-lg text-white">flash_auto</span> 单端口节点订阅地址：<input type="text" class="input form-control form-control-monospace" name="input1" readonly value="{$baseUrl}/link/{$ssr_sub_token}?mu=1" readonly="true"><button class="copy-text btn btn-subscription" type="button" data-clipboard-text="{$baseUrl}/link/{$ssr_sub_token}?mu=1">点击拷贝订阅地址</button><br></p>
                                                        {/if}
                                                      <p><a href="https://wiki.maile3.com/?p=45">点击这里查看Mac傻瓜式教程</a></p>
													</div>
                                                  <div class="tab-pane fade" id="all_ssr_linux">
                                                        ...
                                                        <p><span class="icon icon-lg text-white">flash_auto</span> 单端口节点订阅地址：<input type="text" class="input form-control form-control-monospace" name="input1" readonly value="{$baseUrl}/link/{$ssr_sub_token}?mu=1" readonly="true"><button class="copy-text btn btn-subscription" type="button" data-clipboard-text="{$baseUrl}/link/{$ssr_sub_token}?mu=1">点击拷贝订阅地址</button><br></p>
                                                        {/if}
                                                      <p><a href="https://wiki.maile3.com/?p=270">点击这里查看Linux傻瓜式教程</a></p>
													</div>
													<div class="tab-pane fade" id="all_ssr_ios">
                                                        <p><span class="icon icon-lg text-white">looks_one</span> 使用Safari下载<a href="itms-services://?action=download-manifest&url=https://down.m-e.me/ipa.plist"> <code>Shadowrocket</code></a></p>
                                                        <p><span class="icon icon-lg text-white">looks_two</span> 打开<code>Shadowrocket</code>输入AppleID:<code>
													...
													<div class="tab-pane fade" id="all_ssr_android">
														<p><span class="icon icon-lg text-white">filter_1</span><a href="https://qcloud.coding.net/u/bfsdo0/p/tap-mod/git/raw/master/ssr-android.apk"> 点击我下载</a>并安装</p>
                                                      ...
                                                      <p><span class="icon icon-lg text-white">filter_8</span> 路由选择：略过区域网路以及中国大陆</p>
                                                        ...
                                                        <p><span class="icon icon-lg text-white">flash_auto</span> 单端口节点订阅地址：<input type="text" class="input form-control form-control-monospace" name="input1" readonly value="{$baseUrl}/link/{$ssr_sub_token}?mu=1" readonly="true"><button class="copy-text btn btn-subscription" type="button" data-clipboard-text="{$baseUrl}/link/{$ssr_sub_token}?mu=1">点击拷贝订阅地址</button><br></p>
                                                        {/if}
                                                      <p><a href="https://wiki.maile3.com/?p=27">点击这里查看Android傻瓜式教程</a></p>
													</div>
                                                    ...
                                                    <div class="tab-pane fade" id="all_ssr_game">
														 <p><span class="icon icon-lg text-white">looks_one</span><a href="https://qcloud.coding.net/u/bfsdo0/p/tap-mod/git/raw/master/%E5%8F%AE%E5%BD%93%E5%8A%A0%E9%80%9F%E5%99%A8-setup.exe">点击我下载</a></p>
                                                       ...
                                                       <p><span class="icon icon-lg text-white">looks_5</span> 选择其中一个节点闪电图标测试节点-测试UDP转发...通过!（UDP通过即可连接并开始游戏）</p>
														<!--<p><span class="icon icon-lg text-white">flash_auto</span> 普通节点订阅地址：<input type="text" class="input form-control form-control-monospace" name="input1" readonly value="{$baseUrl}/link/{$ssr_sub_token}?mu=0" readonly="true"><button class="copy-text btn btn-subscription" type="button" data-clipboard-text="{$baseUrl}/link/{$ssr_sub_token}?mu=0">点击拷贝订阅地址</button><br></p>
														<p><span class="icon icon-lg text-white">flash_auto</span> 单端口节点订阅地址：<input type="text" class="input form-control form-control-monospace" name="input1" readonly value="{$baseUrl}/link/{$ssr_sub_token}?mu=1" readonly="true"><button class="copy-text btn btn-subscription" type="button" data-clipboard-text="{$baseUrl}/link/{$ssr_sub_token}?mu=1">点击拷贝订阅地址</button><br></p>
                                                        --->
														<p><a href="https://wiki.maile3.com/?p=22">点击这里查看游戏客户端傻瓜式教程</a></p>
													</div>
												...
												<div class="tab-pane fade {if !$ssr_prefer}active in{/if}" id="all_ss">
													...
													<div class="tab-pane fade" id="all_ss_windows">
														<p><a href="https://qcloud.coding.net/u/bfsdo0/p/tap-mod/git/raw/master/ss-win.zip">下载</a>，解压，运行程序，然后您有两种方式导入所有节点<br>
													...
													<div class="tab-pane fade" id="all_ss_mac">
														<p><a href="https://qcloud.coding.net/u/bfsdo0/p/tap-mod/git/raw/master/ss-mac.zip">下载</a>，安装，然后下载<a href="/user/getpcconf?is_mu=0&is_ss=1">这个（普通端口）</a>或者<a href="/user/getpcconf?is_mu=1&is_ss=1">这个（单端口多用户）</a>，运行程序，小飞机上右键 服务器列表 子菜单 的 “导入服务器配置文件...” 导入这个文件，然后选择一个合适的服务器，更新一下PAC，然后开启系统代理即可上网。</p>
													</div>
													...
													<div class="tab-pane fade" id="all_ss_android">
														<p><a href="https://qcloud.coding.net/u/bfsdo0/p/tap-mod/git/raw/master/ssr-android.apk">下载</a>，再<a href="https://qcloud.coding.net/u/bfsdo0/p/tap-mod/git/raw/master/ss-android-obfs.apk">下载</a>，然后安装，然后在手机上点击 <a class="copy-text" data-clipboard-text="{$ss_url_all}"> 这个链接（普通端口）</a>或者<a class="copy-text" data-clipboard-text="{$ss_url_all_mu}">这个链接（单端口多用户端口）</a>复制到剪贴板，打开 Shadowsocks 客户端，选择从剪贴板导入，然后选择一个节点，设置一下路由为绕过大陆，点击飞机就可以上网了。</p>
													</div>
